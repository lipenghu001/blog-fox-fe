...
import DaoCheng from '../../assets/Daocheng.jpg';
import ErHai from '../../assets/ErHai.jpg';
  ...
  render() {
    ...
    return (
      <div className="right">
        ...
        <div className="title">FirstLoveDog</div>
        ...
        <div className="introduce">
          <div className="title">稻城亚丁</div>
          <div className="content">
            <img style={{'width':'100%'}} src={DaoCheng} alt="稻城亚丁" />
          </div>
        </div>
        <div className="introduce">
          <div className="title">洱海</div>
          <div className="content">
            <img style={{'width':'100%'}} src={ErHai} alt="洱海" />
          </div>
        </div>
      </div>
    );
